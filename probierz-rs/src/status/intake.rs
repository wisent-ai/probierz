...
pub(super) fn parse_bind(bind: &str) -> Result<(&str, u16), Failure> {
...
pub(super) fn random_token() -> Result<String, Failure> {
...
pub(super) fn intake_token() -> Result<(String, bool, PathBuf), Failure> {
...
pub(super) fn handle_connection(mut stream: TcpStream, token: &str) -> Result<(), Failure> {
