...
impl Fixture {
    ...
    fn keychain_value(&self) -> Option<String> {
    ...
    fn route_target(&self) -> Result<Option<String>, String> {
...
fn wait_until<F>(check: F, description: &str) -> Result<(), String>
where
...
fn run_app(context: &specs::Context, executable: &Path, fixture: &Fixture) -> Result<(), String> {
