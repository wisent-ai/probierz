...
export function listHosts() {
  return [
    ...
    { host: "stado:mini", kind: "stado", platform: "darwin", target: "charless-mac-mini", request: { provider: "local", pin_to_provider: true, pinned_host: "charless-mac-mini" }, description: "stado queue, dedicated Mac mini consumer" },
    { host: "stado:macbook", kind: "stado", platform: "darwin", target: "lukasz-macbook", apiUrl: "http://127.0.0.1:18765", request: { provider: "local", pin_to_provider: true, pinned_host: "lukasz-macbook" }, description: "stado queue, dedicated MacBook consumer" },
