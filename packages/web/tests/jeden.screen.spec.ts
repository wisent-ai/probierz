...
import {
  FRAME_BUDGET_AFTER_TWO_OVERLAYS,
  MIN_TWO_PANE_ROWS,
  PROFILES,
  bramaReachableSync,
} from './helpers/jeden-profiles';
 ...
 *
 * The other two groups this file used to hold are beside it now:
 * `jeden.journeys.spec.ts` grades what the keys do across screens, and
 * `jeden.scan.spec.ts` walks the whole command surface.
 */
